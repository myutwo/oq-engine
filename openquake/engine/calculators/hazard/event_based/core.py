...
def compute_and_save_gmfs(job_id, trt_model_id, rupture_data, task_no):
    ...
    with EnginePerformanceMonitor(
        ...
        for rup, rup_id, r_sites, extra in rupture_data:
            calc.calc_gmf(rup, r_sites, extra)
...
class GmfCalculator(object):
    ...
    def calc_gmf(self, rupture, r_sites, rupid_seed_pairs):
        """
...
class EventBasedHazardCalculator(general.BaseHazardCalculator):
    ...
    def task_completed(self, task_result):
        ...
        if rupture_data:
            ...
            for rup, rup_id, r_sites, extra in rupture_data:
                for site_id in r_sites.sids:
                    self.site_ruptures[site_id].add(rup_id)
